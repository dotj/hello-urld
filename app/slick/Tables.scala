...
// Except for https://github.com/slick/slick/issues/2054#event-2492732962
...
trait Tables {
  ...
  lazy val schema: profile.SchemaDescription = DevelopersTable.schema ++ FlywaySchemaHistoryTable.schema
  ...
  implicit def GetResultDevelopersRow(implicit e0: GR[String], e1: GR[Option[String]]): GR[DevelopersRow] = GR { prs =>
    import prs._
  ...
  class DevelopersTable(_tableTag: Tag) extends profile.api.Table[DevelopersRow](_tableTag, None, "developers") {
      ...
      (Rep.Some(installedRank),
       ...
       Rep.Some(success)
        ...
        { r =>
          import r._;
          _1.map(_ =>
            FlywaySchemaHistoryRow.tupled((_1.get, _2, _3.get, _4.get, _5.get, _6, _7.get, _8.get, _9.get, _10.get))
          )
        },
        (_: Any) => throw new Exception("Inserting into ? projection not supported.")
      )
